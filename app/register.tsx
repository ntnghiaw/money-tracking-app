    ...
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        <View
          style={[
            styles.input,
            isFocused.name ? { borderColor: Colors.primary, borderWidth: 1 } : null,
          ]}
        >
          <TextInput
          ...
          />
          <User width={24} height={24} color={Colors.primary} />
        </View>
        <View
          style={[
            styles.input,
            isFocused.email ? { borderColor: Colors.primary, borderWidth: 1 } : null,
          ]}
        >
          <TextInput
            style={styles.inputText}
        ...
        <View
          style={[
            styles.input,
            isFocused.password ? { borderColor: Colors.primary, borderWidth: 1 } : null,
          ]}
        >
          <TextInput
            style={styles.inputText}
