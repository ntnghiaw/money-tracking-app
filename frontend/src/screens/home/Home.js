...
import { getDetailedWallet } from "../../redux/actions/walletAction";
...
const Home = ({ navigation }) => {
  ...
  const { walletId } = route.params || wallets[0]._id;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.expense_structure}>
        <View style={styles.expense_text}>
          <Text>Expense structure</Text>
          <Text style={{ color: "#7D8895" }}>Last 30 Days</Text>
        </View>
        <View style={styles.expense_form}>
          ...
          <View style={styles.expense_categories}>
            <View style={styles.expense_notation}>
              <View
                style={[styles.small_circle, { backgroundColor: "#94C3F6" }]}
              />
              <Text>Shopping</Text>
            </View>
            <View style={styles.expense_notation}>
              <View
                style={[styles.small_circle, { backgroundColor: "#559BE6" }]}
              />
              <Text>Bank Loans</Text>
            </View>
            <View style={styles.expense_notation}>
              <View
                style={[styles.small_circle, { backgroundColor: "#50C474" }]}
              />
              <Text>Saving</Text>
            </View>
            <View style={styles.expense_notation}>
              <View
                style={[styles.small_circle, { backgroundColor: "#94EDF7" }]}
              />
              <Text>Education</Text>
            </View>
          </View>
        ...
        <View style={styles.easy_operations}>
          ...
          <View style={styles.easy_operations_items}>
            <TouchableOpacity
              style={styles.easy_operations_item}
              onPress={() => navigation.navigate("MyWallet")}
            >
              <Image
                style={styles.easy_operations_icon}
                source={change_icon}
              ></Image>
        ...
        <View style={styles.recent_transactions}>
          <Text style={styles.transactions_text}>Recent Transations</Text>
