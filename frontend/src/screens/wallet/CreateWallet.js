    ...
    <View style={styles.container}>
      ...
      >
        <Image
          ...
          source={require("../../images/icons/cash.png")}
        />
        <TextInput
          style={{
      ...
      >
        <Image
          style={{ width: 50, height: 50 }}
          source={require("../../images/icons/balance.png")}
        />
        <TextInput
          style={{
            width: screenWidth * 0.65,
      ...
      >
        <Image
          style={{ width: 50, height: 50 }}
          source={require("../../images/icons/individual.png")}
        />
        <TextInput
          style={{
            width: screenWidth * 0.65,
      ...
      >
        <Image
          ...
          source={require("../../images/icons/description.png")}
        />
        <TextInput
          style={{
            width: screenWidth * 0.65,
