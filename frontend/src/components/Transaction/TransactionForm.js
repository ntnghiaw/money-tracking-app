...
import { View, Text, StyleSheet, Dimensions, TextInput, TouchableOpacity, SafeAreaView, Alert, TouchableWithoutFeedback, AlertButton } from 'react-native';
  ...
  return (
    <View style={styles.form}>
            ...
            <View style={styles.item}>
                ...
                <View style={styles.input}>
                    <TouchableOpacity onPress={() => navigation.navigate('Categories', { edit: false })} >
                        <Text  style={styles.textInput}>{category.name}</Text>
        ...
        <View style={styles.createButton}>
            <PrimaryButton title= 'Save' onPress={onSubmitHandler}/>
        </View>
    </View>
  )
}
