...
//   const [walletType, setWalletType] = useState<'private'| 'shared'>('private')
...
//   const [
//     updateWallet,
//     { data: updatedData, isSuccess: isUpdatedSuccess, isLoading: isUpdatedLoading },
//   ] = useUpdateWalletMutation()
//   const { data: fetchedData } = useGetWalletByIdQuery({
...
//                       placeholderTextColor={NeutralColor.GrayMedium[500]}
//                     />
//                   </View>
//                   <View style={styles.box_input}>
//                     <Image
...
//                       }}
//                     >
//                       <Text style={{ paddingHorizontal: 12, fontSize: 18, color: NeutralColor.GrayMedium[500] }}>
//                         {currency.name ? currency.name : 'Currency'}
//                       </Text>
//                       <ChevronDown width={24} height={24} stroke={NeutralColor.GrayMedium[500]} />
//                     </TouchableOpacity>
//                   </View>
//                   <View style={styles.box_input}>
//                     <Image
...
//             */}
//             <Button title={_id ? 'Save' : 'Create'} onPress={handleSubmit} />
//           </View>
//         </SafeAreaView>
//       </KeyboardAvoidingView>
//     </BottomSheetModalProvider>
